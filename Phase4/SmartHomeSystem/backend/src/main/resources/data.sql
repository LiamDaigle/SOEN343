INSERT INTO rooms (id,name, temperature, desired_temperature, is_hvac_working, override_zone, has_motion_detector) VALUES (0,'Backyard', 10, 12, true, false, false);
INSERT INTO rooms (id,name, temperature, desired_temperature, is_hvac_working, override_zone, has_motion_detector) VALUES (1,'Garage', 12, 12, true, false, false);
INSERT INTO rooms (id,name, temperature, desired_temperature, is_hvac_working, override_zone, has_motion_detector) VALUES (2,'Entrance', 13, 12, true, false, false);
INSERT INTO rooms (id,name, temperature, desired_temperature, is_hvac_working, override_zone, has_motion_detector) VALUES (3,'Bedroom', 40, 12, true, false, false);
INSERT INTO rooms (id,name, temperature, desired_temperature, is_hvac_working, override_zone, has_motion_detector) VALUES (4,'LivingRoom', 45, 12, true, false, false);
...
INSERT INTO home(id, is_away_mode_on, time_to_call_police) VALUES (0, false, 180);